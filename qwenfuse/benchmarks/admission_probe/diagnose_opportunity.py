...
def worker(a):
    ...
    settings = dict(model=str(MODEL), dtype='bfloat16',
        ...
        scheduler_cls='opportunity_scheduler.OpportunityScheduler',
    ...
    summary=dict(mode=a.mode, kv_gib=a.kv_gib, threshold=a.threshold, workload_sha256=hashlib.sha256(data).hexdigest(),
